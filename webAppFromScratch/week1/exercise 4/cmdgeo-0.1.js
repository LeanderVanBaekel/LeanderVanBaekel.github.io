...
(function () {
    ...
    var geo = {
        ...
        init: function () {
            ...
            ET.addListener(gpsUnavailable, function(){debug.message('GPS is niet beschikbaar.')});
        ...
        startInterval: function (event) {
            ...
            ET.addListener(positionUpdate, this.checkLocations);
        },

        // Vraag de huidige positie aan geo.js, stelt een callback in voor het resultaat
        updatePosition: function () {
            intervalCounter++;
            geo_position_js.getCurrentPosition(setPosition, debug.geoErrorHandler, {enableHighAccuracy:true});
        },

        // Callback functie voor het instellen van de huidige positie, vuurt een event af
        setPosition: function (position) {
            currentPosition = position;
            ET.fire("positionUpdate");
        ...
        // TODO: Kan ik hier asynchroon nog de google maps api aanroepen? dit scheelt calls
            ...
            // Zorg dat de kaart geupdated wordt als het positionUpdate event afgevuurd wordt
            ET.addListener(positionUpdate, updatePosition);
        },
