...
/// ***********************************************************************************************************
// This example selects the correc  t library to use based on the board selected under the Tools menu in the IDE.
...
//#define USE_WIFI_SHIELD
    ...
    YunClient client;
      ...
      #include <WiFi.h>
      char ssid[] = "iPhone van Leander van Baekel";          //  your network SSID (name) 
      char pass[] = "31051993";   // your network password
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 106342;
